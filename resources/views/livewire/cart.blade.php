        ...
        <div id="checkout" class="section" style="display: {{ $currentStep == 2 ? 'block' : 'none' }};">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-12 col-lg-6 d-flex flex-column mb-3">
                    ...
                    <input type="text" placeholder="domain.com" class="form-control border rounded p-2" wire:model="domain_name" required>
                    @error('domain_name') <span class="alert alert-danger">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
