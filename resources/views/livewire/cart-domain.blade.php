<div>
    <div class="progress-steps my-5">
        <div class="top">
            ...
            <div class="steps">
                <div class="d-flex flex-column my-3" style="position: relative;">
    ...
    <div class="row ">
        <div id="cart" class="section " style="display: {{ $currentStep == 1 ? 'block' : 'none' }};">
            <div class="fs-5 fw-semibold">Selected Domain : <span class="fs-6 fw-normal"> {{ $dom }} </span></div>
            <div class="row d-flex justify-content-center p-3 gap-2">
                <div class="col-12 col-lg-3 col-sm-6 border rounded-3 p-3 text-center box {{$priceSelectedBox==$plan->price_1_year * 12 ? 'active' : ''}} mb-3 mb-md-0" wire:click="selectBox(1)">
                ...
                <div class="col-12 col-lg-3 col-sm-6 border rounded-3 p-3 text-center box {{$priceSelectedBox==$plan->price_2_years * 24 ? 'active' : ''}} mb-3 mb-md-0" wire:click="selectBox(2)">
                ...
                <div class="col-12 col-lg-3 col-sm-6 border rounded-3 p-3 text-center box {{$priceSelectedBox==$plan->price_3_years * 48 ? 'active' : ''}} mb-3 mb-md-0" wire:click="selectBox(3)">
