                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="d-flex justify-content-between py-4">
                                        <a href="{{route('edit_vps',$plan->id)}}" class="btn btn-warning d-flex align-items-center gap-2">
                                            Edit
                                        </a>
                                        <button onclick="showDeleteConfirmation('{{route('delete_vps',$plan->id)}}')" class="btn btn-danger ">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
