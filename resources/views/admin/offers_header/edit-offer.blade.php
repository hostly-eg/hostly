    ...
    <main class="main-content">
        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="row" method="POST" action="{{route('update_offers_header', $offer->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-md-6">
                            <label for="active">Active</label>
                            <input type="checkbox" name="active" id="active" {{ $offer->active ? 'checked' : '' }}>
                        </div>
                        <center>
                            <div class="form-group col-md-6">
                                <label class="form-label" for="name">Offer Text</label>
                                <textarea name="offer_text" id="offer_text" style="display:none;"></textarea>
...
<script type="text/javascript">
    ...
    document.querySelector('form').addEventListener('submit', function() {
        document.getElementById('offer_text').value = editor.getHTMLCode();
    });
    editor.setHTMLCode(@json($offer->offer_header));
</script>
@endsection
