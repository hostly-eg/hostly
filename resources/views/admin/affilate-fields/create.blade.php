            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Create Affilate Field</h4>
                    </div>
                </div>
                ...
                @endif
                <div class="card-body">
                    <form class="row" action="{{route('store_affilate_field')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="end_prefix" id="end_prefix" class="form-control">
                            </div>
                        </div>
