                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Affilate Fields</h4>
                                </div>
                            </div>
                                    ...
                                    <table id="affilate-fields-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        <tbody>
                                            @foreach($affilateFields as $affilateField)
                                                <tr>
                                                    <td>{{ $affilateField->name }}</td>
                                                    <td>{{ $affilateField->type }}</td>
                                                    <td>{{ $affilateField->end_prefix }}</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{ route('edit_affilate_field', $affilateField->id) }}">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="showDeleteConfirmation('{{ route('delete_affilate_field', $affilateField->id) }}')">
                                                                <span class="btn-inner">
