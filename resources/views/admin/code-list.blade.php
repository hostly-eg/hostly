                                ...
                                <div class="table-responsive">
                                    <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        @foreach($coupons as $coupon)
                                            <tr>
                                                <td>{{$coupon->name}}</td>
                                                <td>{{$coupon->price_discount}}le</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning edit-button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" type="button" data-toggle="modal" data-target="#updateModal" data-id="{{$coupon->id}}" data-name="{{$coupon->name}}" data-price_discount="{{$coupon->price_discount}}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  onclick="showDeleteConfirmation('{{route('delete_code',$coupon->id)}}')">
                                                            <span class="btn-inner">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Edite This Promo Code</h5>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-button').on('click', function() {
                ...
                $('#updateModal input[name="price"]').val(price_discount);
                var action = "{{ route('update_code', ':id') }}".replace(':id', id);
                $('#updateModal form').attr('action', action);
            });
        });
    </script>
@endsection
