                                    ...
                                    <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        @foreach($contact_requests as $contact_request)
                                            <tr>
                                                ...
                                                <td>{{$contact_request->subject}}</td>
                                                <td>{{$contact_request->message}}</td>
                                                <td>{{$contact_request->is_read ? 'Read' : 'Unread'}}</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        @if(!$contact_request->is_read)
                                                            <a class="btn btn-sm btn-icon btn-warning edit-button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{route('read_contact_request',$contact_request->id)}}">
                                                        ...
                                                        @endif
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  onclick="showDeleteConfirmation('{{route('delete_contact_request',$contact_request->id)}}')">
                                                            <span class="btn-inner">
