            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Edit {{$plan->name}} Plan</h4>
                    </div>
                </div>
                ...
                @endif
                <div class="card-body">
                    <form class="row" action="{{route('update_plan',$plan->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-md-6 col-12">
                            <label class="form-label" for="plan_name">Plan Name</label>
                            <input type="text" class="form-control" value="{{$plan->name}}" id="plan_name" name="plan_name">
                            @error('plan_name')
                        ...
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->description}}" id="plan_description" name="plan_description">
                        ...
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->price_1_month}}" id="price_month" name="price_month">
                            @error('price_month')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->price_1_year}}" id="price_12month" name="price_12month">
                            @error('price_12month')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->price_2_years}}" id="price_24month" name="price_24month">
                            @error('price_24month')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->price_3_years}}" id="price_48month" name="price_48month">
                            @error('price_48month')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" class="form-control" value="{{$plan->price_reNew}}" id="plan_Renew" name="plan_Renew">
                            @error('plan_Renew')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
