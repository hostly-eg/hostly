                                    ...
                                    <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        @foreach($team_members as $team_member)
                                            <tr>
                                                ...
                                                <td>{{$team_member->job}}</td>
                                                <td><img width="80" height="50" src="{{asset(route('team_member_image', str_replace('team-member/', '', $team_member->image)))}}" alt="{{$team_member->name}}"></td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning edit-button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{route('edit_team_member',$team_member->id)}}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  onclick="showDeleteConfirmation('{{route('delete_team_member',$team_member->id)}}')">
                                                            <span class="btn-inner">
