            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Create Affilate</h4>
                    </div>
                </div>
                ...
                @endif
                <div class="card-body">
                    <form class="row" action="{{route('store_affilate')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group col-md-9">
                                ...
                                <div class="mb-3  d-flex flex-column">
                                    ...
                                    <input class="p-2 rounded-3 forn-control border" type="{{ $affilateField->type=='text' ? 'text' : 'checkbox' }}" name="fields[{{$affilateField->id}}]"">
                                </div>
                                @endforeach
                            </div>
                        </div>
