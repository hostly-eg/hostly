                                    ...
                                    <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        @foreach($testmonials as $testmonial)
                                            <tr>
                                                ...
                                                <td>{{$testmonial->job_title}}</td>
                                                <td>{{$testmonial->testmonial}}</td>
                                                <td>{{$testmonial->rating}}</td>
                                                <td><img width="80" height="50" src="{{asset(route('client_testmonial_image', str_replace('client-testmonial/', '', $testmonial->image)))}}" alt="{{$testmonial->name}}"></td>
                                                <td>{{$testmonial->status ? 'Active' : 'Inactive'}}</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning edit-button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{route('edit_client_testmonial',$testmonial->id)}}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  onclick="showDeleteConfirmation('{{route('delete_client_testmonial',$testmonial->id)}}')">
                                                            <span class="btn-inner">
