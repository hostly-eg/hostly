    ...
    <main class="main-content">
        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="row" action="{{route('update_partners',$partner->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{asset(route('partner_image', str_replace('partners/', '', $partner->image)))}}" alt="{{$partner->name}}" style="width: 100px; height: 100px;">
                            </div>
                        </div>
