                                ...
                                <div class="table-responsive">
                                    <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                        ...
                                        @foreach($partners as $partner)
                                            <tr>
                                                <td>{{$partner->name}}</td>
                                                <td><img width="80" height="50" src="{{asset(route('partner_image', str_replace('partners/', '', $partner->image)))}}" alt="{{$partner->name}}"></td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning edit-button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{route('edit_partners',$partner->id)}}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  onclick="showDeleteConfirmation('{{route('delete_partners',$partner->id)}}')">
                                                            <span class="btn-inner">
